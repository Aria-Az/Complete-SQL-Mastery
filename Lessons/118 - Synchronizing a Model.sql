...
-- for changes of table, we select synchronize Model from EER Diagram.

-- MySQL Workbench Synchronization
-- Generated: 2025-02-24 21:22
-- Model: New Model
-- Version: 1.0
...
DROP FOREIGN KEY `fk_courses_instructors2`;
...
ALTER TABLE `school`.`courses` 
ADD CONSTRAINT `fk_courses_instructors2`
